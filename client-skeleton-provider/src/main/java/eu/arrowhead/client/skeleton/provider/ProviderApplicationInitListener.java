...
public class ProviderApplicationInitListener extends ApplicationInitListener {
		...
		try{
			while(true){
				...
				if(nodeDescriptionNew.equals(nodeDescription)){
					...
					arrowheadService.unregisterServiceFromServiceRegistry("SignalStatus");
					logger.info("Unregistering service: "+"SignalStatus");
					arrowheadService.unregisterServiceFromServiceRegistry("SignalUpdate");
	...
	public void customDestroy() {
		...
		arrowheadService.unregisterServiceFromServiceRegistry("PlantStructure");
		arrowheadService.unregisterServiceFromServiceRegistry("SignalStatus");
		arrowheadService.unregisterServiceFromServiceRegistry("SignalUpdate");
	}
